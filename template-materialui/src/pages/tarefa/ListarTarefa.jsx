  ...
  const handleDeletar = (id) => {
    ...
    <Card>
        ...
        <CardContent>
            ...
            <Table sx={{ minWidth: 800, marginTop: '20px' }} size="small" aria-label="a dense table">
                <TableHead>
                <TableRow>
                    <TableCell>#</TableCell>
                ...
                {tarefas.map((row, indice) => (
                    ...
                    >
                      ...
                      <TableCell align="center">
                        <Button variant="contained" color="success" sx={{ marginRight: '5px' }} onClick={() => handleEditar(row.idTarefa)}><EditIcon fontSize="small" /></Button>            
                      </TableCell>
                      <TableCell align="center">
